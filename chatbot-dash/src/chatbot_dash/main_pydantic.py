...
from aithena_services.llms.types.message import Message, SystemMessage


logger = get_logger(__file__)

# we initialize history with the system prompt
messages: solara.Reactive[list[Message]] = solara.reactive([Message({"role": "system", "content":PROMPT})])
...
def Page():
    ...
    ChatBotPydantic(messages, current_llm_name, current_llm)